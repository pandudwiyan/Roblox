...
-- JUDUL: Gunung Arunika (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(-831.23,59.13,-443.54)},
    {name="CP1", pos=Vector3.new(135.18,143.06,-175.83)},
    {name="CP2", pos=Vector3.new(326.20,90.71,-434.38)},
    {name="CP3", pos=Vector3.new(475.88,170.73,-940.24)},
    {name="CP4", pos=Vector3.new(929.77,134.31,-625.98)},
    {name="CP5", pos=Vector3.new(923.37,102.59,280.10)},
    {name="Pra-Summit", pos=Vector3.new(252.97,252.74,771.27)},
    {name="Summit", pos=Vector3.new(246.54,325.98,692.98)},
}
