...
-- JUDUL: Gunung Lawak (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(-203.77,37.01,-279.14)},
    {name="CP1", pos=Vector3.new(-251.27,32.23,20.01)},
    {name="CP2", pos=Vector3.new(284.00,323.63,-190.15)},
    {name="CP3", pos=Vector3.new(307.62,402.91,129.17)},
    {name="CP4", pos=Vector3.new(-193.05,178.40,242.20)},
    {name="CP5", pos=Vector3.new(451.94,391.95,-72.82)},
    {name="CP6", pos=Vector3.new(528.97,570.38,-319.01)},
    {name="CP7", pos=Vector3.new(1443.40,1129.44,-1301.11)},
    {name="CP8", pos=Vector3.new(1794.83,1479.17,-1964.06)},
    {name="Summit", pos=Vector3.new(2838.90,2624.23,-1843.05)},
}
