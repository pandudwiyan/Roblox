...
-- JUDUL: Gunung Bima Sakti (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(4.80,67.36,8.41)},
    {name="CP1", pos=Vector3.new(-445.03,158.84,59.79)},
    {name="CP2", pos=Vector3.new(-537.71,79.25,-679.29)},
    {name="CP3", pos=Vector3.new(-215.70,176.80,-883.10)},
    {name="CP4", pos=Vector3.new(194.45,80.20,-1554.07)},
    {name="CP5", pos=Vector3.new(-304.88,86.01,-2491.22)},
    {name="CP6", pos=Vector3.new(1835.66,71.31,-1836.84)},
    {name="Summit", pos=Vector3.new(1738.21,55.70,-1845.32)},
}
