...
-- JUDUL: Gunung Kocak (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(-454.37,33.93,478.11)},
    {name="CP1", pos=Vector3.new(-5.91,172.11,-93.47)},
    {name="Summit", pos=Vector3.new(-63.02,281.12,-345.54)},
}
