...
-- JUDUL: Gunung CKPTW (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(525.12,14.17,-991.58)},
    {name="CP1", pos=Vector3.new(387.29,309.85,-184.81)},
    {name="CP2", pos=Vector3.new(100.73,412.45,616.56)},
    {name="CP3", pos=Vector3.new(11.44,601.35,998.37)},
    {name="CP4", pos=Vector3.new(873.77,865.06,580.02)},
    {name="CP5", pos=Vector3.new(1617.88,1080.34,157.90)},
    {name="CP6", pos=Vector3.new(2970.18,1527.81,708.32)},
    {name="Puncak", pos=Vector3.new(1784.75,1985.67,2174.90)},
}
