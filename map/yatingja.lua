...
-- JUDUL: Gunung Yatingja (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(650.71,457.62,647.02)},
    {name="CP1", pos=Vector3.new(555.51,653.18,97.12)},
    {name="CP2", pos=Vector3.new(51.76,329.62,523.83)},
    {name="CP3", pos=Vector3.new(-532.09,441.62,582.52)},
    {name="CP4", pos=Vector3.new(-383.77,573.62,-32.26)},
    {name="Summit", pos=Vector3.new(606.08,891.78,-570.44)},
}
