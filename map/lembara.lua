...
-- JUDUL: Gunung Lembara (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(-36.00,13.31,-446.41)},
    {name="CP2", pos=Vector3.new(676.04,22.15,-748.43)},
    {name="CP3", pos=Vector3.new(772.84,243.85,275.33)},
    {name="CP4", pos=Vector3.new(433.63,209.34,282.98)},
    {name="CP5", pos=Vector3.new(69.49,383.95,448.85)},
    {name="CP6", pos=Vector3.new(-536.88,294.17,95.05)},
    {name="CP7", pos=Vector3.new(-656.35,878.10,-125.58)},
    {name="Summit", pos=Vector3.new(-320.74,1092.33,-415.35)},
}
