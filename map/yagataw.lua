...
-- JUDUL: Gunung Yagataw (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(-237.75,38.17,187.75)},
    {name="CP1", pos=Vector3.new(-420.43,192.45,555.87)},
    {name="CP2", pos=Vector3.new(-625.65,579.59,1137.36)},
    {name="CP3", pos=Vector3.new(-900.09,691.22,1220.89)},
    {name="CP4", pos=Vector3.new(-386.67,1042.17,2046.41)},
    {name="CP5", pos=Vector3.new(-754.92,1526.17,2061.63)},
    {name="CP6", pos=Vector3.new(-481.09,1634.17,2286.43)},
    {name="CP7", pos=Vector3.new(-85.56,1930.17,2114.30)},
    {name="Summit", pos=Vector3.new(2.07,2494.17,2044.03)},
}
