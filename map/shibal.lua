...
-- JUDUL: Gunung Shibal (Versi Simple Drag + Minimize)
...
-- Data Lokasi
local locations = {
    {name="Base", pos=Vector3.new(-936.77,14.17,-193.57)},
    {name="CP2", pos=Vector3.new(-466.66,139.19,-832.56)},
    {name="CP3", pos=Vector3.new(807.10,173.85,-832.05)},
    {name="CP4", pos=Vector3.new(-97.90,41.39,-632.05)},
    {name="CP5", pos=Vector3.new(-89.84,578.95,70.95)},
    {name="Puncak", pos=Vector3.new(-696.54,10.27,619.17)},
}
