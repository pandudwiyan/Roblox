...
RunService.RenderStepped:Connect(function()
	...
	elseif not UIS:IsKeyDown(Enum.KeyCode.W) and not UIS:IsKeyDown(Enum.KeyCode.A) and not UIS:IsKeyDown(Enum.KeyCode.S) and not UIS:IsKeyDown(Enum.KeyCode.D) and not UIS:IsKeyDown(Enum.KeyCode.Space) then
		-- tetap ke target
	else
		-- kembali ke player
