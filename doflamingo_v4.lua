-- Player Teleporter v4.1 + Search Optimized + Summon Feature
...
main.Size = UDim2.new(0, 300, 0, 270) -- lebih tinggi karena tombol summon
...
title.Text = "Player Teleporter v4.1"
...
searchBox:GetPropertyChangedSignal("Text"):Connect(function()
    ...
    task.delay(0.1, function()
        if tick() - searchDebounce >= 0.1 then
...
-- Auto refresh saat dropdown terbuka
...
local function summonToFront(targetPlayer)
    ...
    local myHRP = myChar and myChar:FindFirstChild("HumanoidRootPart")
    if targetHRP and myHRP then
        local frontPos = myHRP.CFrame * CFrame.new(0, 0, -5) -- jarak depan
...
summonBtn.Size = UDim2.new(1,-20,0,30)
summonBtn.Position = UDim2.new(0,10,0,230)
summonBtn.BackgroundColor3 = Color3.fromRGB(0,0,100)
summonBtn.TextColor3 = Color3.new(1,1,1)
summonBtn.Text = "Summon"
summonBtn.Parent = main
