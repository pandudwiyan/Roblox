-- Player Teleporter Simple Navigation UI v1.0
...
bringBtn.Size = UDim2.new(0.3, -10, 0, 30)
bringBtn.Position = UDim2.new(0.7, 0, 0, 60)
bringBtn.Text = "Bring"
...
-- Fungsi quick teleport (ke orang terdekat di depan)
...
UIS.InputBegan:Connect(function(input, gp)
    ...
    elseif input.UserInputType == Enum.UserInputType.Gamepad1 then
        -- Semua tombol analog dianggap gerak
        local hum = LP.Character and LP.Character:FindFirstChild("Humanoid")
        if hum then
            Camera.CameraSubject = hum
        end
