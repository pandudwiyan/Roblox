...
if parentGui:FindFirstChild("PlayerTeleporterV3") then parentGui.PlayerTeleporterV3:Destroy() end

-- GUI utama
local gui = Instance.new("ScreenGui")
gui.Name = "PlayerTeleporterV3"
...
title.Text = "Player Teleporter v3"
...
local function refreshPlayerList()
    ...
    for _, plr in ipairs(Players:GetPlayers()) do
        if plr ~= LP then
            ...
            dn.TextColor3 = Color3.fromRGB(255, 255, 0) -- kuning
            ...
            un.Text = plr.Name
            un.TextColor3 = Color3.fromRGB(255, 255, 255) -- putih
...
-- Button Quick Teleport
local quickBtn = Instance.new("TextButton")
quickBtn.Size = UDim2.new(0.5, -15, 0, 30)
quickBtn.Position = UDim2.new(0.5, 5, 0, 140)
